...
import { ChevronRight, Calendar, ArrowUpRight, Check } from 'lucide-react';
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8 text-white transform translate-y-4 group-hover:translate-y-0 transition-all">
                <div className="flex items-center gap-2 mb-2">
                   <span className="bg-accent-emerald text-white text-[10px] font-black px-2 py-1 rounded-full uppercase tracking-widest">सफल</span>
                   <span className="text-xs font-bold opacity-80 uppercase tracking-widest">मुस्ताङ सोलार प्रोजेक्ट</span>
                </div>
                <h4 className="text-2xl font-bold font-headline mb-2 leading-tight">नवीकरणीय ऊर्जा विस्तार चरण १</h4>
                <p className="text-sm opacity-80 line-clamp-2">४०० भन्दा बढी घरधुरीमा स्वच्छ ऊर्जाको पहुँच सुनिश्चित गरिएको छ।</p>
              </div>
            </motion.div>
          </div>
              ...
              {updates.map((update, i) => (
                ...
                >
                  <div className="flex-shrink-0 w-16 h-16 rounded-xl bg-surface-container flex flex-col items-center justify-center border border-outline-variant group-hover:bg-primary group-hover:text-white transition-all duration-300">
                    <span className="text-xs font-black uppercase tracking-widest opacity-60 group-hover:opacity-100 leading-none mb-1">SEP</span>
                    <span className="text-2xl font-black leading-none">{12-i}</span>
                  </div>
                  ...
                  <div className="flex-shrink-0 w-10 h-10 rounded-full bg-surface-container border border-outline-variant flex items-center justify-center text-on-surface-variant group-hover:bg-primary group-hover:text-white group-hover:rotate-45 transition-all duration-500">
